            ...
            return {
                ...
                GET_FILE_SIZE_LABELS: function (e) {
                    return {
                        ...
                        labelKilobytes:
                            e("GET_LABEL_FILE_SIZE_KILOBYTES") || void 0,
                        labelMegabytes:
                            e("GET_LABEL_FILE_SIZE_MEGABYTES") || void 0,
                        labelGigabytes:
                            e("GET_LABEL_FILE_SIZE_GIGABYTES") || void 0,
                    };
                },
            };
        },
                        ...
                        if ((t = t || f.find(L))) {
                            ...
                            var n =
                                ...
                                d = (t.request = rt(
                                    n(t.data),
                                    l,
                                    Object.assign({}, p, { headers: c })
                                ));
                            (d.onload = function (e) {
                                s(e, t.index, f.length),
                                    (t.status = ct),
                                    (t.request = null),
                                    w();
                            }),
                                (d.onprogress = function (e, n, r) {
                ...
                s = Object.assign({}, pe(), {
                    process: function (t, o) {
                        var i = function () {
                            ...
                            a = function () {
                                (n.complete = !0),
                                    s.fire("load-perceived", n.response.body);
                            };
                        s.fire("start"),
                            ...
                            (n.request = e(
                                ...
                                function () {
                                    n.perceivedPerformanceUpdater.clear(),
                                        s.fire(
                                            "abort",
                                            n.response ? n.response.body : null
                                        );
                                },
                                function (e) {
                                    s.fire("transfer", e);
            ...
            return {
                ...
                DID_SET_FILES: function (t) {
                    ...
                    i.forEach(function (t) {
                        ...
                        o.forEach(function (t, n) {
                            i.find(function (e) {
                                return (
                                    e.source === t.source || e.file === t.source
                                );
                            }) ||
                                e(
                                    "ADD_ITEM",
                ...
                ADD_ITEM: function (r) {
                    var o = r.source,
                        ...
                        p = void 0 === d ? {} : d;
                    if (M(o))
                        f({ error: ot("error", 0, "No source"), file: null });
                    else if (
                        !ht(o) ||
                        ...
                        v.on("init", function () {
                            ...
                            v.on("load", function () {
                                ...
                                Oe("DID_LOAD_ITEM", v, {
                                    ...
                                    .then(function () {
                                        At(
                                            t("GET_BEFORE_ADD_FILE"),
                                            Te(v)
                                        ).then(r);
                                    })
                                    .catch(function (t) {
                                        if (!t || !t.error || !t.status)
                                            return r(!1);
                                        e("DID_THROW_ITEM_INVALID", {
                                            id: h,
                                            error: t.error,
                            ...
                            v.on("process-error", function (t) {
                                e("DID_THROW_ITEM_PROCESSING_ERROR", {
                                    ...
                                    status: {
                                        main: Dt(
                                            n.options.labelFileProcessingError
                                        )(t),
                                        sub: n.options.labelTapToRetry,
                                    },
                                });
                ...
                REQUEST_PREPARE_OUTPUT: function (e) {
                    ...
                    Oe("PREPARE_OUTPUT", n.file, { query: t, item: n }).then(
                        function (e) {
                    ...
                    if (t("GET_ITEMS_BY_STATUS", Ie.PROCESSING).length !== a) {
                        if (r.status !== Ie.PROCESSING) {
                            ...
                            r.onOnce("process-complete", function () {
                                ...
                                t("GET_ITEMS_BY_STATUS", Ie.PROCESSING_COMPLETE)
    ...
    var Kt,
            ...
            create: function (e) {
                ...
                if (
                    (f &&
                        ...
                        (sn.DID_THROW_ITEM_PROCESSING_ERROR.status.translateX =
                            Jt)),
                    d && s)
                ) {
                    i.RevertItemProcessing.align =
                ...
                u || (i.RemoveItem.disabled = !0),
                    t(i, function (e, t) {
                        ...
                        p.includes(e) && r.appendChildView(n),
                            ...
                            (n.element.dataset.align = r.query(
                                "GET_STYLE_" + t.align
                            )),
                    ...
                    (r.ref.info = r.appendChildView(
                        r.createChildView(kt, { id: a })
                    )),
                    (r.ref.status = r.appendChildView(
                        r.createChildView(zt, { id: a })
                    ));
        ...
        An = S({
            ...
            didWriteView: function (e) {
                ...
                t.childViews
                    .filter(function (e) {
                        return (
                            e.markedForRemoval && 0 === e.opacity && e.resting
                        );
                    })
                    .forEach(function (e) {
        ...
        Ln = A({
            DID_DRAG: function (e) {
                ...
                t.query("GET_ITEM_INSERT_LOCATION_FREEDOM") &&
                    (n.dragCoordinates = {
                        left:
                            r.position.scopeLeft - t.ref.list.rect.element.left,
                        top:
                            r.position.scopeTop -
                            (t.rect.outer.top +
            ...
            create: function (e) {
                ...
                (t.element.id = "filepond--browser-" + n.id),
                    ...
                    (t.ref.handleChange = function (e) {
                        if (t.element.value) {
                            var r = Array.from(t.element.files).map(function (
                                e
                            ) {
                                return (
                                    (e._relativePath = e.webkitRelativePath), e
                                );
                            });
                            setTimeout(function () {
                                n.onload(r),
        ...
        Kn = S({
            ...
            create: function (e) {
                ...
                (n.textContent = "Files"), t.element.appendChild(n);
            },
            write: Zn,
            ignoreRect: !0,
        }),
                ...
                t = {
                    destroy: function () {
                        ...
                        (t = e),
                            de(Lr, Lr.indexOf(t)),
                            0 === Lr.length &&
                                (document.removeEventListener("paste", br),
                                (Ar = !1));
                    },
                    onload: function () {},
                };
            return (
                (function (e) {
                    Lr.includes(e) ||
                        ...
                        Ar ||
                            ((Ar = !0),
                            document.addEventListener("paste", br)));
                })(e),
                t
            );
        },
                    ...
                    },
                    {
                        filterItems: function (t) {
                            ...
                            return t.filter(function (e) {
                                return (
                                    !ht(e) || !n.includes(e.name.toLowerCase())
                                );
                            });
                        },
            ...
            r && !e.ref.paster
                ? ((e.ref.paster = Pr()),
                  (e.ref.paster.onload = function (t) {
                      Oe("ADD_ITEMS", t, { dispatch: e.dispatch }).then(
                          function (t) {
                              if (Xr(e, t)) return !1;
                              e.dispatch("ADD_ITEMS", {
                                  items: t,
        ...
        $r = S({
            ...
            create: function (e) {
                ...
                t.query("GET_ALLOW_REORDER") &&
                    a &&
                    !i &&
                    (t.element.addEventListener("touchmove", Yr, {
                        passive: !1,
                    }),
                ...
                if (2 === s.length) {
                    ...
                    (u.className = "filepond--credits"),
                        ...
                        (u.tabIndex = -1),
                        (u.target = "_blank"),
                        (u.rel = "noopener noreferrer nofollow"),
                        (u.textContent = s[1]),
            ...
            write: function (e) {
                ...
                if (
                    ...
                    if (
                        ((u.translateY =
                            Math.max(0, m - u.rect.element.marginTop) - T.top),
                        c)
                    ) {
                        ...
                        l.scalable = !1;
                        var C =
                            o.fixedHeight - m - (g - T.bottom) - (p ? h : 0);
                        ...
                        if (
                            (t.hasOwnProperty("error") &&
                                (n.error = t.error
                                    ...
                                    : null),
                            t.status &&
                                (n.status = Object.assign({}, t.status)),
