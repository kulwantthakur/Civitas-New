(function () {
   ...
   */
        ...
        return a
            ...
            : function (b) {
                  ...
                  for (var e = 0; e < d.length; e++)
                      ("jscomp_symbol_" == d[e].substring(0, 14) ? b : c).push(
                          d[e]
                      );
                  return c.concat(b);
              };
    ...
    function bb(a, b) {
        a: {
            var c = ((a.ownerDocument && a.ownerDocument.defaultView) || A)
                .document;
            if (
                c.querySelector &&
        ...
        for (var d = (c = !1); a.l.length && !a.o; ) {
            ...
            if ((h = a.j ? f : h))
                try {
                    ...
                    g === ec && (g = void 0);
                    void 0 !== g &&
                        ((a.j = a.j && (g == b || g instanceof Error)),
                        (a.h = b = g));
                    if (
                        Nb(b) ||
                        ("function" === typeof A.Promise &&
                            b instanceof A.Promise)
                    )
                        (d = !0), (a.o = !0);
                } catch (k) {
                    (b = k), (a.j = !0), fc(a) || (c = !0);
   ...
   */
    ...
    function Kc(a, b) {
        ...
        do {
            if (a === b[a])
                throw Error(
                    "Infinite loop in version mapping for version " + a
                );
            (c = b[a]) && (a = c);
        } while (c);
        return a;
    ...
    if (sc) console.warn("Google Charts loader.js should only be loaded once.");
        ...
        var Nc = document.getElementsByTagName("script"),
            Oc = (document.currentScript || Nc[Nc.length - 1]).getAttribute(
                "src"
            ),
            Pc = new L(Oc),
            Qc = Pc.g;
        ...
        if ("string" === typeof Uc)
            try {
                if ("" !== Uc)
                    for (
                        var Vc = JSON.parse(Uc).modules, Wc = 0;
                        Wc < Vc.length;
                        Wc++
                    ) {
                        var Xc = Vc[Wc];
