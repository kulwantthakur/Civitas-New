        ...
        timelineClicked(e) {
            this.moveplayhead(e),
                (this.mediaEl.currentTime =
                    this.duration * this.clickPercent(e));
        }
        mouseDown() {
            (this.onplayhead = !0),
            ...
            d.utils.createView({
                ...
                create: ({ root: a, props: s }) => {
                        ...
                        d.utils.createView({
                            ...
                            create: ({ root: e, props: t }) => {
                                ...
                                if (
                                    ...
                                    (e.ref.audio = []),
                                        (e.ref.audio.container =
                                            document.createElement("div")),
                                        (e.ref.audio.button =
                                            document.createElement("span")),
                                        (e.ref.audio.timeline =
                                            document.createElement("div")),
                                        (e.ref.audio.playhead =
                                            document.createElement("div")),
                                        (e.ref.audio.container.className =
                                            "audioplayer"),
                                        (e.ref.audio.button.className =
                                            "playpausebtn play"),
                                        (e.ref.audio.timeline.className =
                                            "timeline"),
                                        (e.ref.audio.playhead.className =
                                            "playhead"),
                                        e.ref.audio.timeline.appendChild(
                                            e.ref.audio.playhead
                                        ),
                                        e.ref.audio.container.appendChild(
                                            e.ref.audio.button
                                        ),
                                        e.ref.audio.container.appendChild(
                                            e.ref.audio.timeline
                    ...
                    a.ref.media = a.appendChildView(
                        a.createChildView(n, { id: s.id })
                    );
                },
                write: d.utils.createRoute({
                    DID_MEDIA_PREVIEW_CONTAINER_CREATE: ({
                        root: e,
                        props: i,
                    }) => {
                        const { id: t } = i;
